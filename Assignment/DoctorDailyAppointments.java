...
public class DoctorDailyAppointments extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jDateChooser1.getDate() != null) {
            ...
            if (a == 0) {
                JOptionPane.showMessageDialog(this, "No appointment found!", "Search Appointment", JOptionPane.INFORMATION_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Please select a date!", "Search Appointment", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (row != -1) {
            ...
            String date = model1.getValueAt(row, 3).toString();
            String time = model1.getValueAt(row, 4).toString();
            new AddMedicalRecord(icno, date, time).setVisible(true);
            this.dispose();
        } else {
