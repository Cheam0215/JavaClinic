...
public class MedicalRecord extends javax.swing.JFrame {
    ...
    public MedicalRecord() {
        ...
        populateTableFromFile("C:\\Users\\Maxcm\\Desktop\\assg\\medicalRecords.txt");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Testing.PatientMain patientMenu = new Testing.PatientMain();
    ...
    private void populateTableFromFile(String filePath) {
        ...
        for (String[] row : data) {
                String ic = row[2];
            String status = row[7];
            if (ic.equals(icNumber) && "Paid".equalsIgnoreCase(status)) {
