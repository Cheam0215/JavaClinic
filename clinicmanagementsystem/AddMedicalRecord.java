...
public class AddMedicalRecord extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (diagnosis == null || diagnosis.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Diagnosis field cannot be empty.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (prescription == null || prescription.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Prescription field cannot be empty.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
