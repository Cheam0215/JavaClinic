...
//        String birthDate = DateFormat.getDateInstance().format(date);
        String role = "Patient";
        if (ICNumber.isEmpty() || username.isEmpty() || password.isEmpty() || gender.isEmpty() || formattedDate.isEmpty() || role.isEmpty()) {
        JOptionPane.showMessageDialog(this, "All fields are required.");
        return;
    }
        Patient patient = new Patient(ICNumber, username, password, gender, formattedDate);
